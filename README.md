...
## 🌐 Socials:
[![Facebook](https://img.shields.io/badge/Facebook-%231877F2.svg?logo=Facebook&logoColor=white)](https://facebook.com/aziz.kira.581) 
    ...
    <style type="text/css">
      <![CDATA[
          @font-face {
            ...
            <div class="container">
                <h3> Nobody knows how to build really complicated hardware systems, so designing hardware tends to be simpler. Software is much more complicated.</h3>
                <p>- Butler Lampson</p>
            </div>
        </div>
    </foreignObject>
